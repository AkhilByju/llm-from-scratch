...
All version 2 models revolve around Byte Pair Encoding **(BPE)** tokenization and the consecutive versions are just modifcations to the parameters, vocab size, or other variables.
